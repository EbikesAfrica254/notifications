...
public final class OrganizationPreferenceSpecifications {
  ...
  private OrganizationPreferenceSpecifications() {
    throw new UnsupportedOperationException(ApplicationConstants.CLASS_CANNOT_BE_INSTANTIATED);
  }

  public static Specification<OrganizationChannelPreference> buildSpecification(
